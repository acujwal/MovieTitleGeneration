...
public class MovieTitleGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Random x = new Random();
        int nounLength = 0 + x.nextInt(nouns.length);
        int adjectivesLength = 0 + x.nextInt(adjectives.length - 1);
        ...
        String adjective = adjectives[adjectivesLength];
        ;
        String noun = nouns[nounLength];
